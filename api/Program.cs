...
// Set up Swagger so we can test with it easily. This builds JWT into Swagger
...
builder.Services.AddAuthentication(options => {
    ...
    options.TokenValidationParameters = new TokenValidationParameters {
        ...
        IssuerSigningKey = new SymmetricSecurityKey(
            System.Text.Encoding.UTF8.GetBytes(builder.Configuration.GetSection("JWT:SigningKey").Value!)
        )
    };
});

// Dependency injection to wire up repo services
